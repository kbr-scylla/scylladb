...
void list_service_level_attachments_statement::validate(service::storage_proxy &, const service::client_state &) {
}

future<> list_service_level_attachments_statement::check_access(const service::client_state &state) {
