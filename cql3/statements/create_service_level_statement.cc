...
void create_service_level_statement::validate(service::storage_proxy &, const service::client_state &) {
}

future<> create_service_level_statement::check_access(const service::client_state &state) {
